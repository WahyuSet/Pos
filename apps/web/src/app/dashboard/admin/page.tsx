...
export default function AdminDashboard() {
  ...
  const [activeSubTab, setActiveSubTab] = useState<'menu' | 'categories' | 'tables' | 'settings'>('menu');
  ...
  if (!restaurantId || isCatsLoading || isTablesLoading || isMenusLoading || isRestLoading) {
    return (
